...
from brewgis.contrib.footprint.lib.functions import remove_keys, flatten

from footprint.main.mixins.dynamic import Dynamic
from footprint.main.mixins.revisionable import Revisionable
from brewgis.contrib.footprint.utils.model_utils import classproperty
from brewgis.contrib.footprint.geospatial.built_form_feature import BuiltFormFeature
...
class Feature(models.Model, Revisionable, Dynamic):
    ...
    dynamic_model_class_creator_class = 'brewgis.contrib.footprint.feature.feature_class_creator.FeatureClassCreator'

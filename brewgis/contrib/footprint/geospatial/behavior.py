...
from brewgis.contrib.footprint.lib.functions import merge, remove_keys, any_true, flat_map, accumulate
...
from brewgis.contrib.footprint.geospatial.intersection import Intersection, GeographicIntersection

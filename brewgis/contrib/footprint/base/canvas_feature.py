...
from brewgis.contrib.footprint.geospatial.feature import PaintingFeature
import logging
...
class CanvasFeature(PaintingFeature):
    ...
    def post_save(cls, user_id, objects, **kwargs):
        ...
        from brewgis.contrib.footprint.analysis_module.analysis_module import AnalysisModuleKey, AnalysisModule

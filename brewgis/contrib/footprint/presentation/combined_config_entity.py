...
from brewgis.contrib.footprint.config.global_config import global_config_singleton
from brewgis.contrib.footprint.lib.functions import flat_map, remove_keys, merge, unique

...
from brewgis.contrib.footprint.keys.analysis_field_keys import AnalysisFieldKeys
from brewgis.contrib.footprint.keys.built_form_keys import BuiltFormKeys
from brewgis.contrib.footprint.keys.srs_keys import SRSKeys
from brewgis.contrib.footprint.keys.template_keys import TemplateKeys

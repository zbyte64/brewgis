...
from brewgis.contrib.footprint.lib.functions import map_to_dict, merge, unique, flat_map, filter_dict, my_deep_copy, first, any_true, remove_keys
...
from brewgis.contrib.footprint.dynamic_model_class_creator import DynamicModelClassCreator
from brewgis.contrib.footprint.geospatial.feature_class_configuration import FeatureClassConfiguration
from brewgis.contrib.footprint.geospatial.feature_version import feature_revision_manager
from brewgis.contrib.footprint.utils.dynamic_subclassing import get_dynamic_model_class_name, dynamic_model_class, \
    resolve_dynamic_model_class
from brewgis.contrib.footprint.utils.inline_inspectdb import InlineInspectDb
from brewgis.contrib.footprint.utils.model_utils import limited_api_fields
from brewgis.contrib.footprint.utils.query_parsing import related_field_paths_to_fields
from brewgis.contrib.footprint.utils.utils import resolve_module_attr, split_filter
...
class FeatureClassCreator(DynamicModelClassCreator):
    ...
    def dynamic_geography_class_name(self, geography_scope_id=None):
        ...
        :return:
        """
        return get_dynamic_model_class_name(resolve_module_attr('brewgis.contrib.footprint.geographies.geography.Geography'),
    ...
    def dynamic_geography_class(self, geography_scope=None):
        ...
        return dynamic_model_class(
            resolve_module_attr('brewgis.contrib.footprint.geographies.geography.Geography'),
            scope.schema(),
            'geography',

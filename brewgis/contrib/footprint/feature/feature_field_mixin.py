...
from brewgis.contrib.footprint.lib.functions import map_to_dict, merge, compact_dict, map_dict_to_dict, flat_map
...
from brewgis.contrib.footprint.utils.query_parsing import resolve_related_model_path_via_geographies, related_field_paths
from brewgis.contrib.footprint.utils.utils import resolve_module_attr, resolve_model

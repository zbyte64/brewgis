...
class PhBlockGroupOutcomesFeature(Feature):
    """
    A class of block group geographic features containing the outcomes of the Public Health analyses - this is the
    reporting scale of the model
    """
    

    blockgroup = models.CharField(max_length=20, null=True, blank=True)

{#
    ...
    Quick Start Mode (transport_quick_start = true):
        - When enabled, ITE default trip generation rates are used directly
        - No custom built_form trip_rate_overrides or pass_by_trip_pct needed
        - Seeds for ITE default rates are loaded from seeds/test_parcels.csv
        - Production: requires built_forms table with trip_rate_override and
          pass_by_trip_pct columns, or ITE rate seeds pre-loaded

...
class ImputationEngine:
    ...
    def apply(
        ...
        Each rule is applied independently (rules targeting different columns
        do not interact). Returns a list of ``ImputationResult`` — one per
        rule — so callers can log or assert on imputation outcomes.

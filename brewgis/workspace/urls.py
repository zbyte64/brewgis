...
from .views import analysis_card_status
...
from .views import grid_preview
...
from .views import merge_preview
...
from .views import preview_classify
...
urlpatterns = [
    ...
    path(
        "<int:workspace_pk>/scenario/<int:scenario_pk>/paint/grid/preview/",
        grid_preview,
        name="grid_preview",
    ),
    path(
    ...
    path(
        "<int:workspace_pk>/scenario/<int:scenario_pk>/paint/merge/preview/",
        merge_preview,
        name="merge_preview",
    ),
    path(
    ...
    path(
        "symbology/<int:layer_pk>/preview-classify/",
        preview_classify,
        name="symbology_preview_classify",
    ),
    path(
    ...
    path(
        ...
        name="analysis_card_status",
    ),
    path(
        "workspace/<int:workspace_pk>/panel/analysis/<str:module_key>/configure/",
        analysis_module_configure,
        name="analysis_module_configure",
    ),
    path(
        "workspace/<int:workspace_pk>/panel/analysis/<str:module_key>/launch/",
        analysis_module_launch,
        name="analysis_module_launch",
    ),
    path(

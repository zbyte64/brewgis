MODEL (
  name brewgis.fresno.overture_intersection_points,
  kind FULL,
  column_descriptions (
...
-- Reads from the PostgreSQL bridge table (already materialized from DuckDB).
...
-- post_statements
  CREATE INDEX IF NOT EXISTS idx_fresno_intersection_points_geometry_@snapshot_hash

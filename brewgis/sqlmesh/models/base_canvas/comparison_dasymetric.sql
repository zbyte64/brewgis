MODEL (
  ...
  kind FULL,
  description 'Parcel-level dasymetric comparison table with APN values allocated by intersection-area share.',
  column_descriptions (
    parcel_id = 'Unique parcel identifier from the parcel shim.',
    geometry = 'Parcel geometry from the parcel shim (EPSG:4326).',
    lot_size_acres = 'Lot size summed over the APNs intersecting the parcel (acres).',
    actual_living_sqft = 'Living floor area allocated to the parcel by intersection-area share (sq ft).',
    actual_building_sqft = 'Building floor area allocated to the parcel by intersection-area share (sq ft).',
    residential_building_sqft = 'Residential building floor area allocated by intersection-area share (sq ft).',
    commercial_building_sqft = 'Commercial building floor area allocated by intersection-area share (sq ft).',
    industrial_building_sqft = 'Industrial building floor area allocated by intersection-area share (sq ft).',
    other_building_sqft = 'Other building floor area allocated by intersection-area share (sq ft).',
    total_footprint_sqft = 'Total building footprint area allocated by intersection-area share (sq ft).',
    building_count = 'Building count allocated by intersection-area share, rounded to a whole number.',
    pop_dasym_weight = 'Population dasymetric weight summed over the intersecting APNs (sq ft).',
    emp_dasym_weight = 'Employment dasymetric weight summed over the intersecting APNs (sq ft).',
    du = 'Dwelling units allocated from DU estimation by intersection-area share.',
    du_pop_dasym_weight = 'Population weight from DU estimation allocated by intersection-area share (people).',
    hh_dasym_weight = 'Household weight from DU estimation allocated by intersection-area share (households).',
    hh = 'Households allocated from DU estimation by intersection-area share.',
    du_detsf_sl = 'Predicted detached single-family small-lot dwelling units, allocated by area share.',
    du_detsf_ll = 'Predicted detached single-family large-lot dwelling units, allocated by area share.',
    du_attsf = 'Predicted attached single-family dwelling units, allocated by area share.',
    du_mf2to4 = 'Predicted multi-family 2-4 unit dwelling units, allocated by area share.',
    du_mf5p = 'Predicted multi-family 5+ unit dwelling units, allocated by area share.',
    du_total_regressor = 'Predicted total dwelling units allocated by intersection-area share.',
    bldg_area_detsf_sl = 'Predicted detached single-family small-lot building area, allocated by area share (sq ft).',
    bldg_area_detsf_ll = 'Predicted detached single-family large-lot building area, allocated by area share (sq ft).',
    bldg_area_attsf = 'Predicted attached single-family building area, allocated by area share (sq ft).',
    bldg_area_mf = 'Predicted multi-family building area, allocated by area share (sq ft).',
    bldg_area_retail_services = 'Predicted retail services building area, allocated by area share (sq ft).',
    bldg_area_restaurant = 'Predicted restaurant building area, allocated by area share (sq ft).',
    bldg_area_accommodation = 'Predicted accommodation building area, allocated by area share (sq ft).',
    bldg_area_arts_entertainment = 'Predicted arts and entertainment building area, area-share allocated (sq ft).',
    bldg_area_other_services = 'Predicted other services building area, allocated by area share (sq ft).',
    bldg_area_office_services = 'Predicted office services building area, allocated by area share (sq ft).',
    bldg_area_public_admin = 'Predicted public administration building area, allocated by area share (sq ft).',
    bldg_area_education = 'Predicted education building area, allocated by area share (sq ft).',
    bldg_area_medical_services = 'Predicted medical services building area, allocated by area share (sq ft).',
    bldg_area_transport_warehousing = 'Predicted transport and warehousing building area, allocated by share (sq ft).',
    bldg_area_wholesale = 'Predicted wholesale building area, allocated by area share (sq ft).',
    apn = 'Assessor parcel number of the APN with the largest intersection area for the parcel.',
    land_development_category = 'Land development category of the APN with the largest intersection area.',
    built_form_key = 'Built form key of the APN with the largest intersection area.',
    du_subtype = 'Dwelling unit subtype placeholder; null in this model.',
    ...
    emp_off_per_acre = 'Office employment per acre from the employment-ratios regressor (jobs per acre).',
    emp_pub_per_acre = 'Public employment per acre from the employment-ratios regressor (jobs per acre).',
    emp_ind_per_acre = 'Industrial employment per acre from the employment-ratios regressor (jobs per acre).',
    emp_ag_per_acre = 'Agricultural employment per acre from the employment-ratios regressor (jobs per acre).'
  ),
  audits (

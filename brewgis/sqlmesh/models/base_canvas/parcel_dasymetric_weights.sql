MODEL (
  ...
  description 'APN-level dasymetric weights from the region adapters, plus population and employment weights.',
  column_descriptions (
    apn = 'Assessor parcel number (APN) of the parcel.',
    landuse = 'Land use code from the assessor parcels adapter.',
    lot_size_acres = 'Lot size of the parcel from the assessor parcels adapter (acres).',
    zone = 'Zoning code from the assessor parcels adapter.',
    land_development_category = 'Land development category, defaulting to urban when the adapter value is empty.',
    actual_living_sqft = 'Living floor area from the sales adapter (sq ft); 0 when absent.',
    actual_building_sqft = 'Building floor area from the sales adapter (sq ft); 0 when absent.',
    property_type = 'Property type label from the sales adapter.',
    sales_lot_size_acres = 'Lot size from the sales adapter (acres).',
    units = 'Assessor-reported dwelling units from the sales adapter.',
    residential_building_sqft = 'Residential building floor area (sq ft); 0 when the adapter has no value.',
    commercial_building_sqft = 'Commercial building floor area (sq ft); 0 when the adapter has no value.',
    industrial_building_sqft = 'Industrial building floor area (sq ft); 0 when the adapter has no value.',
    other_building_sqft = 'Other building floor area (sq ft); 0 when the adapter has no value.',
    total_footprint_sqft = 'Total building footprint area (sq ft); 0 when the adapter has no value.',
    building_count = 'Number of buildings on the parcel (integer); 0 when absent.',
    footprint_ratio = 'Building footprint area divided by parcel area (0-1); 0 when absent.',
    max_levels = 'Maximum building level count (integer); NULL when absent.',
    intersection_density = 'All-road intersection density at the parcel (intersections per km2).',
    highway_intersection_density = 'Highway intersection density at the parcel (intersections per km2).',
    path_intersection_density = 'Path intersection density at the parcel (intersections per km2).',
    pc01 = 'ResNet principal component 01 of the parcel imagery (regressor feature); 0 when absent.',
    pc02 = 'ResNet principal component 02 of the parcel imagery (regressor feature); 0 when absent.',
    pc03 = 'ResNet principal component 03 of the parcel imagery (regressor feature); 0 when absent.',
    pc04 = 'ResNet principal component 04 of the parcel imagery (regressor feature); 0 when absent.',
    pc05 = 'ResNet principal component 05 of the parcel imagery (regressor feature); 0 when absent.',
    pc06 = 'ResNet principal component 06 of the parcel imagery (regressor feature); 0 when absent.',
    pc07 = 'ResNet principal component 07 of the parcel imagery (regressor feature); 0 when absent.',
    pc08 = 'ResNet principal component 08 of the parcel imagery (regressor feature); 0 when absent.',
    pc09 = 'ResNet principal component 09 of the parcel imagery (regressor feature); 0 when absent.',
    pc10 = 'ResNet principal component 10 of the parcel imagery (regressor feature); 0 when absent.',
    pc11 = 'ResNet principal component 11 of the parcel imagery (regressor feature); 0 when absent.',
    pc12 = 'ResNet principal component 12 of the parcel imagery (regressor feature); 0 when absent.',
    pc13 = 'ResNet principal component 13 of the parcel imagery (regressor feature); 0 when absent.',
    pc14 = 'ResNet principal component 14 of the parcel imagery (regressor feature); 0 when absent.',
    pc15 = 'ResNet principal component 15 of the parcel imagery (regressor feature); 0 when absent.',
    pc16 = 'ResNet principal component 16 of the parcel imagery (regressor feature); 0 when absent.',
    pc17 = 'ResNet principal component 17 of the parcel imagery (regressor feature); 0 when absent.',
    pc18 = 'ResNet principal component 18 of the parcel imagery (regressor feature); 0 when absent.',
    pc19 = 'ResNet principal component 19 of the parcel imagery (regressor feature); 0 when absent.',
    pc20 = 'ResNet principal component 20 of the parcel imagery (regressor feature); 0 when absent.',
    pc21 = 'ResNet principal component 21 of the parcel imagery (regressor feature); 0 when absent.',
    pc22 = 'ResNet principal component 22 of the parcel imagery (regressor feature); 0 when absent.',
    pc23 = 'ResNet principal component 23 of the parcel imagery (regressor feature); 0 when absent.',
    pc24 = 'ResNet principal component 24 of the parcel imagery (regressor feature); 0 when absent.',
    pc25 = 'ResNet principal component 25 of the parcel imagery (regressor feature); 0 when absent.',
    pc26 = 'ResNet principal component 26 of the parcel imagery (regressor feature); 0 when absent.',
    pc27 = 'ResNet principal component 27 of the parcel imagery (regressor feature); 0 when absent.',
    pc28 = 'ResNet principal component 28 of the parcel imagery (regressor feature); 0 when absent.',
    pc29 = 'ResNet principal component 29 of the parcel imagery (regressor feature); 0 when absent.',
    pc30 = 'ResNet principal component 30 of the parcel imagery (regressor feature); 0 when absent.',
    pc31 = 'ResNet principal component 31 of the parcel imagery (regressor feature); 0 when absent.',
    pc32 = 'ResNet principal component 32 of the parcel imagery (regressor feature); 0 when absent.',
    pop_dasym_weight = 'Population weight: authoritative or estimated residential floor area (sq ft).',
    emp_dasym_weight = 'Employment weight: non-residential floor area scaled by intersection density (sq ft).'
  ),
  audits (
...
WITH parcel_features AS (
    SELECT
        ...
        bs.max_levels::integer AS max_levels,

MODEL (
  ...
  description 'Building footprint attributes per assessor parcel from combined Overture and VIDA buildings.',
  column_descriptions (
    apn = 'Assessor parcel number (APN) identifying the parcel.',
    geometry = 'Assessor parcel geometry (EPSG:4326).',
    lot_size_acres = 'Parcel lot size from the assessor record (acres).',
    total_footprint_sqft = 'Building floor area on the parcel (sq ft): footprint x levels x overlap ratio, summed.',
    building_count = 'Number of buildings intersecting the parcel (Overture plus de-duplicated VIDA).',
    max_height = 'Height of the tallest building on the parcel (metres), null where unknown.',
    max_levels = 'Number of floors in the tallest building on the parcel, null where unknown.',
    google_building_count = 'Number of VIDA Google buildings intersecting the parcel.',
    microsoft_building_count = 'Number of VIDA Microsoft buildings intersecting the parcel.',
    mean_confidence = 'Mean VIDA confidence score of the buildings on the parcel.',
    residential_building_sqft = 'Overlap-weighted footprint area of residential buildings (sq ft).',
    non_residential_building_sqft = 'Overlap-weighted footprint area of non-residential buildings (sq ft).',
    ...
    distinct_class_categories = 'Number of distinct building class categories present on the parcel.',
    overture_commercial_sqft = 'Overture commercial-class floor area (sq ft), including mixed-use ground floors.',
    overture_residential_sqft = 'Overture residential-class floor area (sq ft), including mixed-use upper floors.',

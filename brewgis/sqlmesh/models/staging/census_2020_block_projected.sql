...
-- post_statements
  ...
  ON brewgis.staging.census_2020_block_projected USING GIST (geometry);
  CREATE INDEX IF NOT EXISTS idx_c2020_block_proj_geoid
  ON brewgis.staging.census_2020_block_projected (geoid);
ANALYZE brewgis.staging.census_2020_block_projected;

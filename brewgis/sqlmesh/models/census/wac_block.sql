MODEL (
  ...
  kind FULL,
  description 'Block-level employment from wac_block_raw with the LODES C000 disclosure gap distributed over the sub-sectors and optional CBP county scaling applied, one row per block.',
  column_descriptions (
    geoid = '15-digit census block GEOID (state+county+tract+block FIPS) of the block.',
    geometry = 'Block geometry (EPSG:4326) carried through from wac_block_raw.',
    emp = 'Total employment of the block, recomputed as the sum of the 17 scaled sub-sectors (jobs).',
    emp_agriculture = 'Agricultural employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_extraction = 'Extraction employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_construction = 'Construction employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_manufacturing = 'Manufacturing employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_transport_warehousing = 'Transport/warehousing employment (jobs) after the C000 gap and CBP scaling.',
    emp_utilities = 'Utilities employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_wholesale = 'Wholesale employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_retail_services = 'Retail services employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_office_services = 'Office services employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_education = 'Education employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_medical_services = 'Medical services employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_arts_entertainment = 'Arts/entertainment employment (jobs) after the C000 gap distribution and CBP scaling.',
    emp_accommodation = 'Accommodation employment (jobs) after the C000 gap distribution and CBP scaling.',
    ...
    emp_ind = 'Industrial employment (jobs): manufacturing, wholesale, transport, utilities, construction and goods.',
    emp_ag = 'Agricultural employment (jobs), equal to the scaled emp_agriculture.'
  ),
  audits (

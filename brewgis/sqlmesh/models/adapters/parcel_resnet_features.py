...
@model(
    ...
    description="Per-parcel 32-component PCA features of ResNet-34 embeddings from NAIP imagery.",
    column_descriptions={
        "parcel_id": "Parcel identifier the imagery features belong to.",
        "apn": "Assessor parcel number (APN); equals parcel_id for Fresno parcels.",

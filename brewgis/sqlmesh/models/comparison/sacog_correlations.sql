...
stats AS (
    SELECT
        ...
        SUM(w * du_detsf) AS swy_du_detsf,
        ...
        SUM(w * du_detsf_sl) AS swy_du_detsf_sl,
        ...
        SUM(w * du_detsf_ll) AS swy_du_detsf_ll,
        ...
        SUM(w * du_attsf) AS swy_du_attsf,
        ...
        SUM(w * du_mf2to4) AS swy_du_mf2to4,
        ...
        SUM(w * emp_retail_services) AS swy_emp_retail_services,
        ...
        SUM(w * emp_restaurant) AS swy_emp_restaurant,
        ...
        SUM(w * emp_accommodation) AS swy_emp_accommodation,
        ...
        SUM(w * emp_arts_entertainment) AS swy_emp_arts_entertainment,
        ...
        SUM(w * emp_other_services) AS swy_emp_other_services,
        ...
        SUM(w * emp_office_services) AS swy_emp_office_services,
        ...
        SUM(w * emp_medical_services) AS swy_emp_medical_services,
        ...
        SUM(w * emp_public_admin) AS swy_emp_public_admin,
        ...
        SUM(w * emp_education) AS swy_emp_education,
        ...
        SUM(w * emp_manufacturing) AS swy_emp_manufacturing,
        ...
        SUM(w * emp_wholesale) AS swy_emp_wholesale,
        ...
        SUM(w * emp_transport_warehousing) AS swy_emp_transport_warehousing,
        ...
        SUM(w * emp_utilities) AS swy_emp_utilities,
        ...
        SUM(w * emp_construction) AS swy_emp_construction,
        ...
        SUM(w * emp_agriculture) AS swy_emp_agriculture,
        ...
        SUM(w * emp_extraction) AS swy_emp_extraction,
        ...
        SUM(w * emp_military) AS swy_emp_military,

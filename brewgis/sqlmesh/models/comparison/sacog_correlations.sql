...
stats AS (
    SELECT
        ...
        SUM(w * ref_pop * ref_pop) AS swyy_pop,
        SUM(w * pop * ref_pop) AS swxy_pop,
        -- hh
        SUM(w * hh) AS swx_hh,
        SUM(w * ref_hh) AS swy_hh,
        SUM(w * hh * hh) AS swxx_hh,
        SUM(w * ref_hh * ref_hh) AS swyy_hh,
        SUM(w * hh * ref_hh) AS swxy_hh,
        -- du
        SUM(w * du) AS swx_du,
        SUM(w * ref_du) AS swy_du,
        SUM(w * du * du) AS swxx_du,
        SUM(w * ref_du * ref_du) AS swyy_du,
        SUM(w * du * ref_du) AS swxy_du,
        -- du_detsf
        SUM(w * du_detsf) AS swx_du_detsf,
        SUM(w * ref_du_detsf) AS swy_du_detsf,
        SUM(w * du_detsf * du_detsf) AS swxx_du_detsf,
        SUM(w * ref_du_detsf * ref_du_detsf) AS swyy_du_detsf,
        SUM(w * du_detsf * ref_du_detsf) AS swxy_du_detsf,
        -- du_detsf_sl
        ...
        SUM(w * ref_du_detsf_sl * ref_du_detsf_sl) AS swyy_du_detsf_sl,
        SUM(w * du_detsf_sl * ref_du_detsf_sl) AS swxy_du_detsf_sl,
        -- du_detsf_ll
        ...
        SUM(w * ref_du_detsf_ll * ref_du_detsf_ll) AS swyy_du_detsf_ll,
        SUM(w * du_detsf_ll * ref_du_detsf_ll) AS swxy_du_detsf_ll,
        -- du_attsf
        SUM(w * du_attsf) AS swx_du_attsf,
        SUM(w * ref_du_attsf) AS swy_du_attsf,
        SUM(w * du_attsf * du_attsf) AS swxx_du_attsf,
        SUM(w * ref_du_attsf * ref_du_attsf) AS swyy_du_attsf,
        SUM(w * du_attsf * ref_du_attsf) AS swxy_du_attsf,
        -- du_mf
        SUM(w * du_mf) AS swx_du_mf,
        SUM(w * ref_du_mf) AS swy_du_mf,
        SUM(w * du_mf * du_mf) AS swxx_du_mf,
        SUM(w * ref_du_mf * ref_du_mf) AS swyy_du_mf,
        SUM(w * du_mf * ref_du_mf) AS swxy_du_mf,
        -- du_mf2to4
        SUM(w * du_mf2to4) AS swx_du_mf2to4,
        SUM(w * ref_du_mf2to4) AS swy_du_mf2to4,
        SUM(w * du_mf2to4 * du_mf2to4) AS swxx_du_mf2to4,
        SUM(w * ref_du_mf2to4 * ref_du_mf2to4) AS swyy_du_mf2to4,
        SUM(w * du_mf2to4 * ref_du_mf2to4) AS swxy_du_mf2to4,
        -- du_mf5p
        SUM(w * du_mf5p) AS swx_du_mf5p,
        SUM(w * ref_du_mf5p) AS swy_du_mf5p,
        SUM(w * du_mf5p * du_mf5p) AS swxx_du_mf5p,
        SUM(w * ref_du_mf5p * ref_du_mf5p) AS swyy_du_mf5p,
        SUM(w * du_mf5p * ref_du_mf5p) AS swxy_du_mf5p,
        -- emp
        SUM(w * emp) AS swx_emp,
        SUM(w * ref_emp) AS swy_emp,
        SUM(w * emp * emp) AS swxx_emp,
        SUM(w * ref_emp * ref_emp) AS swyy_emp,
        SUM(w * emp * ref_emp) AS swxy_emp,
        -- emp_ret
        SUM(w * emp_ret) AS swx_emp_ret,
        SUM(w * ref_emp_ret) AS swy_emp_ret,
        SUM(w * emp_ret * emp_ret) AS swxx_emp_ret,
        SUM(w * ref_emp_ret * ref_emp_ret) AS swyy_emp_ret,
        SUM(w * emp_ret * ref_emp_ret) AS swxy_emp_ret,
        -- emp_retail_services
        ...
        SUM(w * ref_emp_retail_services * ref_emp_retail_services) AS swyy_emp_retail_services,
        SUM(w * emp_retail_services * ref_emp_retail_services) AS swxy_emp_retail_services,
        -- emp_restaurant
        ...
        SUM(w * ref_emp_restaurant * ref_emp_restaurant) AS swyy_emp_restaurant,
        SUM(w * emp_restaurant * ref_emp_restaurant) AS swxy_emp_restaurant,
        -- emp_accommodation
        ...
        SUM(w * ref_emp_accommodation * ref_emp_accommodation) AS swyy_emp_accommodation,
        SUM(w * emp_accommodation * ref_emp_accommodation) AS swxy_emp_accommodation,
        ...
        SUM(w * ref_emp_arts_entertainment * ref_emp_arts_entertainment) AS swyy_emp_arts_entertainment,
        SUM(w * emp_arts_entertainment * ref_emp_arts_entertainment) AS swxy_emp_arts_entertainment,
        -- emp_other_services
        ...
        SUM(w * ref_emp_other_services * ref_emp_other_services) AS swyy_emp_other_services,
        SUM(w * emp_other_services * ref_emp_other_services) AS swxy_emp_other_services,
        -- emp_off
        SUM(w * emp_off) AS swx_emp_off,
        SUM(w * ref_emp_off) AS swy_emp_off,
        SUM(w * emp_off * emp_off) AS swxx_emp_off,
        SUM(w * ref_emp_off * ref_emp_off) AS swyy_emp_off,
        SUM(w * emp_off * ref_emp_off) AS swxy_emp_off,
        -- emp_office_services
        ...
        SUM(w * ref_emp_office_services * ref_emp_office_services) AS swyy_emp_office_services,
        SUM(w * emp_office_services * ref_emp_office_services) AS swxy_emp_office_services,
        ...
        SUM(w * ref_emp_medical_services * ref_emp_medical_services) AS swyy_emp_medical_services,
        SUM(w * emp_medical_services * ref_emp_medical_services) AS swxy_emp_medical_services,
        -- emp_pub
        SUM(w * emp_pub) AS swx_emp_pub,
        SUM(w * ref_emp_pub) AS swy_emp_pub,
        SUM(w * emp_pub * emp_pub) AS swxx_emp_pub,
        SUM(w * ref_emp_pub * ref_emp_pub) AS swyy_emp_pub,
        SUM(w * emp_pub * ref_emp_pub) AS swxy_emp_pub,
        -- emp_public_admin
        ...
        SUM(w * ref_emp_public_admin * ref_emp_public_admin) AS swyy_emp_public_admin,
        SUM(w * emp_public_admin * ref_emp_public_admin) AS swxy_emp_public_admin,
        -- emp_education
        ...
        SUM(w * ref_emp_education * ref_emp_education) AS swyy_emp_education,
        SUM(w * emp_education * ref_emp_education) AS swxy_emp_education,
        -- emp_ind
        SUM(w * emp_ind) AS swx_emp_ind,
        SUM(w * ref_emp_ind) AS swy_emp_ind,
        SUM(w * emp_ind * emp_ind) AS swxx_emp_ind,
        SUM(w * ref_emp_ind * ref_emp_ind) AS swyy_emp_ind,
        SUM(w * emp_ind * ref_emp_ind) AS swxy_emp_ind,
        -- emp_manufacturing
        ...
        SUM(w * ref_emp_manufacturing * ref_emp_manufacturing) AS swyy_emp_manufacturing,
        SUM(w * emp_manufacturing * ref_emp_manufacturing) AS swxy_emp_manufacturing,
        -- emp_wholesale
        ...
        SUM(w * ref_emp_wholesale * ref_emp_wholesale) AS swyy_emp_wholesale,
        SUM(w * emp_wholesale * ref_emp_wholesale) AS swxy_emp_wholesale,
        ...
        SUM(w * ref_emp_transport_warehousing * ref_emp_transport_warehousing) AS swyy_emp_transport_warehousing,
        SUM(w * emp_transport_warehousing * ref_emp_transport_warehousing) AS swxy_emp_transport_warehousing,
        -- emp_utilities
        ...
        SUM(w * ref_emp_utilities * ref_emp_utilities) AS swyy_emp_utilities,
        SUM(w * emp_utilities * ref_emp_utilities) AS swxy_emp_utilities,
        -- emp_construction
        ...
        SUM(w * ref_emp_construction * ref_emp_construction) AS swyy_emp_construction,
        SUM(w * emp_construction * ref_emp_construction) AS swxy_emp_construction,
        -- emp_ag
        SUM(w * emp_ag) AS swx_emp_ag,
        SUM(w * ref_emp_ag) AS swy_emp_ag,
        SUM(w * emp_ag * emp_ag) AS swxx_emp_ag,
        SUM(w * ref_emp_ag * ref_emp_ag) AS swyy_emp_ag,
        SUM(w * emp_ag * ref_emp_ag) AS swxy_emp_ag,
        -- emp_agriculture
        ...
        SUM(w * ref_emp_agriculture * ref_emp_agriculture) AS swyy_emp_agriculture,
        SUM(w * emp_agriculture * ref_emp_agriculture) AS swxy_emp_agriculture,
        -- emp_extraction
        ...
        SUM(w * ref_emp_extraction * ref_emp_extraction) AS swyy_emp_extraction,
        SUM(w * emp_extraction * ref_emp_extraction) AS swxy_emp_extraction,
        -- emp_military
        ...
        SUM(w * ref_emp_military * ref_emp_military) AS swyy_emp_military,
        SUM(w * emp_military * ref_emp_military) AS swxy_emp_military,
        -- bldg_area_detsf_sl
